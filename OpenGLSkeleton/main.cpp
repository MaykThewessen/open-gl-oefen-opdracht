...
void init()
{
	...
	glutKeyboardFunc(keyfunc);						// added in part 1 intro Open GL
...
void display()
{
	...
	int x = 300, y = 300;			// Position where text is drawn
	drawText(keytext, x, y);		// text drawing function mayk
